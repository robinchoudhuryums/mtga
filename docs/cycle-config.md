...
**MODEL AGREEMENT** (`check_agreement.py`) is the last of the ten HARD gates and the one that
covers what the others structurally cannot: **two functions that are each correct
